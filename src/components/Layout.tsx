  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d1b2e' }}>
      <header style={{
        ...
        <NavLink to="/" onClick={() => setPanelSeleccionado(null)} style={{ textDecoration: 'none', color: 'inherit', display: 'flex', alignItems: 'center' }}>
          <div style={{
            fontWeight: 800,
            fontSize: 20,
            color: '#4db8ff',
        ...
        <SearchBar onSelect={setFichaRecambio} />
